...
# 定义需要请求的链接
telegram_url = "https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Surge/Telegram/Telegram.list"
region_urls = [
...
# 将字符串写入文件
try:
    with open("./Surge/Telegram_Global.list", "w", encoding="utf-8") as f:
        f.write(result_text)
except IOError as e:
