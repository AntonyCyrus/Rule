...
urls = [
    ...
    "https://raw.githubusercontent.com/HotKids/Rules/master/Quantumult/X/Filter/TVer.list",
    "https://raw.githubusercontent.com/HotKids/Rules/master/Quantumult/X/Filter/U-NEXT.list"
]
...
# 将字符串写入文件
with open("./Quantumult X/JPMedia.list", "w", encoding="utf-8") as f:
    f.write(result_text)
